...
function PANEL:Initialize()
	...
	toppanel.Paint = function(myself,w,h)
		...
		local r = GetConVar("nz_ui_color_accent_r") and GetConVar("nz_ui_color_accent_r"):GetInt() or 130
		local g = GetConVar("nz_ui_color_accent_g") and GetConVar("nz_ui_color_accent_g"):GetInt() or 130
		local b = GetConVar("nz_ui_color_accent_b") and GetConVar("nz_ui_color_accent_b"):GetInt() or 215
		draw.RoundedBox( 0, 0, 0, w, h, ColorAlpha( Color(r, g, b), ( self.Wep:GetInspectingProgress() or 0 ) * 128 ) )
	end
