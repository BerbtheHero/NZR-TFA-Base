...
local function tfaOptionVM(panel)
	...
	tfaOptionCL.Options["#preset.default"] = {
		...
		cl_tfa_gunbob_sway_intensity = "1",
		cl_tfa_gunbob_custom = "1",
		cl_tfa_gunbob_style = "0",
	...
	panel:NumSlider("#tfa.vmsettings.gunswaymult", "cl_tfa_gunbob_sway_intensity", 0, 2, 2)
	panel:AddControl("ComboBox", {
		Label = "#tfa.vmsettings.gunbobstyle",
		MenuButton = "1",
		Options = {
			["#tfa.vmsettings.gunbobstyle.breaddarsu"] = { cl_tfa_gunbob_style = "0" },
			["#tfa.vmsettings.gunbobstyle.fesiug"] = { cl_tfa_gunbob_style = "1" },
			["#tfa.vmsettings.gunbobstyle.arctic"] = { cl_tfa_gunbob_style = "2" },
			["#tfa.vmsettings.gunbobstyle.darsu"] = { cl_tfa_gunbob_style = "3" },
			["#tfa.vmsettings.gunbobstyle.bread"] = { cl_tfa_gunbob_style = "4" },
			["#tfa.vmsettings.gunbobstyle.blackops"] = { cl_tfa_gunbob_style = "5" },
			["#tfa.vmsettings.gunbobstyle.hl2"] = { cl_tfa_gunbob_style = "-1" },
		},
		CVars = { "cl_tfa_gunbob_style" }
	})
...
local function tfaOptionHUD(panel)
	...
	hudpnl:Help("")
	local fm_cmb = hudpnl:ComboBox("#tfa.hudsettings.firemodenotifier.label", "cl_tfa_hud_firemode_notify")
	fm_cmb:SetSortItems(false)
	fm_cmb:AddChoice("#tfa.hudsettings.firemodenotifier.off", 0)
	fm_cmb:AddChoice("#tfa.hudsettings.firemodenotifier.printmessage", 1)
	fm_cmb:AddChoice("#tfa.hudsettings.firemodenotifier.notification", 2)
...
local function tfaOptionInspect(panel)
	...
	presetTable.Options["#preset.default"] = {
		...
		cl_tfa_inspect_hide_creator = "0",
		cl_tfa_inspect_hide_manufacturer = "0",
		cl_tfa_inspect_hide_capacity = "0",
		cl_tfa_inspect_hide_ammo = "0",
		cl_tfa_inspect_hide_contact = "0",
		cl_tfa_inspect_hide_attachments = "1",
		cl_tfa_inspect_hide_origin = "0",
	...
	panel:CheckBox("#tfa.inspectsettings.hidecreator", "cl_tfa_inspect_hide_creator")
	panel:CheckBox("#tfa.inspectsettings.hidemanufacturer", "cl_tfa_inspect_hide_manufacturer")
	panel:CheckBox("#tfa.inspectsettings.hidecapacity", "cl_tfa_inspect_hide_capacity")
	panel:CheckBox("#tfa.inspectsettings.hideammo", "cl_tfa_inspect_hide_ammo")
	panel:CheckBox("#tfa.inspectsettings.hidecontact", "cl_tfa_inspect_hide_contact")
	panel:CheckBox("#tfa.inspectsettings.hideattachments", "cl_tfa_inspect_hide_attachments")
	panel:CheckBox("#tfa.inspectsettings.hideorigin", "cl_tfa_inspect_hide_origin")
