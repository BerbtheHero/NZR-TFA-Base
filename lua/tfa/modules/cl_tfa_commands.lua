...
if GetConVar("cl_tfa_inspect_newbars") == nil then
	CreateClientConVar("cl_tfa_inspect_newbars", 1, true, false, "Use new stat bars in inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_creator") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_creator", 1, true, false, "Hide creator from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_manufacturer") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_manufacturer", 1, true, false, "Hide manufacturer from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_capacity") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_capacity", 1, true, false, "Hide capacity from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_ammo") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_ammo", 1, true, false, "Hide ammo type from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_contact") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_contact", 1, true, false, "Hide contact from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_attachments") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_attachments", 1, true, false, "Hide attachment selector from inspection screen")
end

if GetConVar("cl_tfa_inspect_hide_origin") == nil then
	CreateClientConVar("cl_tfa_inspect_hide_origin", 0, true, false, "Hide origin from inspection screen")
end
...
if GetConVar("cl_tfa_gunbob_intensity") == nil then
	CreateClientConVar("cl_tfa_gunbob_intensity", 1, true, false, "Gun bob speed multiplier", 0, 10)
end

if GetConVar("cl_tfa_gunbob_sway_intensity") == nil then
	CreateClientConVar("cl_tfa_gunbob_sway_intensity", 1, true, false, "Gun sway intensity multiplier", 0, 10)
end
...
if GetConVar("cl_tfa_gunbob_style") == nil then
	CreateClientConVar("cl_tfa_gunbob_style", 5, true, false, "Gun bob style (0 - Bread & Darsu, 1 - Fesiug, 2 - Arctic, 3 - Darsu, 4 - Bread exaggerated, 5 - CoD Black Ops, -1 - Half-Life 2)", -1, 5)
end
...
if GetConVar("cl_tfa_gunbob_anim_mode") == nil then
	CreateClientConVar("cl_tfa_gunbob_anim_mode", 0, true, false, "Gunbob animation mode (0 - Auto, 1 - Force both, 2 - Gunbob only)", 0, 2)
end
...
if GetConVar("cl_tfa_ironsights_toggle") == nil then
	CreateClientConVar("cl_tfa_ironsights_toggle", 0, true, true, "Toggle ironsights?")
end
...
if GetConVar("cl_tfa_hud_crosshair_pump") == nil then
	CreateClientConVar("cl_tfa_hud_crosshair_pump", 1, true, false, "Enable pump feedback on crosshair?")
end

if GetConVar("cl_tfa_hud_hitmarker_enabled") == nil then
	CreateClientConVar("cl_tfa_hud_hitmarker_enabled", 0, true, false, "Enable hit marker?")
end
...
if GetConVar("cl_tfa_hud_enabled") == nil then
	CreateClientConVar("cl_tfa_hud_enabled", 0, true, false, "Enable 3D2D hud?")
end

if GetConVar("cl_tfa_hud_fallback_enabled") == nil then
	CreateClientConVar("cl_tfa_hud_fallback_enabled", 0, true, false, "Enable basic fallback hud?")
end
...
if GetConVar("cl_tfa_fx_muzzleflashsmoke") == nil then
	CreateClientConVar("cl_tfa_fx_muzzleflashsmoke", 0, true, true, "Enable muzzleflash smoke?")
end

if GetConVar("cl_tfa_legacy_shells") == nil then
	CreateClientConVar("cl_tfa_legacy_shells", 1, true, true, "Use legacy shells?")
end
...
if GetConVar("cl_tfa_fx_ejectionlife") == nil then
	CreateClientConVar("cl_tfa_fx_ejectionlife", 5, true, true, "How long shells exist in the world")
end
...
if GetConVar("cl_tfa_hud_keybindhints_enabled") == nil then
	CreateClientConVar("cl_tfa_hud_keybindhints_enabled", "0", true, false, "Enable keybind hints?")
end
...
if GetConVar("cl_tfa_hud_firemode_notify") == nil then
	CreateClientConVar("cl_tfa_hud_firemode_notify", 0, true, false, "Display firemode notifier on change")
end
